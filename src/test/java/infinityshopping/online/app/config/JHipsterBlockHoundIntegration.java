...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("infinityshopping.online.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("infinityshopping.online.app.security.DomainUserDetailsService", "createSpringSecurityUser");
